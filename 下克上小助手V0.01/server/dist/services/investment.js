...
exports.ARMAMENT_LEVELS = exports.NAVY_LEVELS = exports.COMMERCE_LEVELS = exports.AGRICULTURE_LEVELS = exports.INVESTMENT_CONFIGS = void 0;
exports.calculateSuccessRate = calculateSuccessRate;
exports.calculateModifierCoefficient = calculateModifierCoefficient;
exports.rollD100 = rollD100;
exports.determineOutcome = determineOutcome;
exports.calculatePointsGained = calculatePointsGained;
exports.getInvestmentLevel = getInvestmentLevel;
exports.getInvestmentPreview = getInvestmentPreview;
exports.executeInvestment = executeInvestment;
exports.getInvestmentStatus = getInvestmentStatus;
exports.getAvailableSamuraisForInvestment = getAvailableSamuraisForInvestment;
const storage_1 = require("../storage");
// 四大投资系统配置
exports.INVESTMENT_CONFIGS = {
    agriculture: {
 ...
 */
function calculateSuccessRate(samuraiAttribute) {
 ...
 * @returns 修正系数
 */
function calculateModifierCoefficient(samuraiAttribute) {
 ...
 * @returns 投资结果类型
 */
function determineOutcome(roll, successRate) {
    if (roll < 5) {
 ...
 * @returns 获得的点数
 */
function calculatePointsGained(outcome, basePoints, modifierCoefficient) {
    switch (outcome) {
 ...
 * @returns 等级名称
 */
function getInvestmentLevel(type, points) {
 ...
 * 获取投资类型对应的等级表
 */
function getLevelsForType(type) {
    switch (type) {
        case 'agriculture':
            return exports.AGRICULTURE_LEVELS;
        case 'commerce':
            return exports.COMMERCE_LEVELS;
        case 'navy':
            return exports.NAVY_LEVELS;
        case 'armament':
            return exports.ARMAMENT_LEVELS;
    }
}
/**
 * 获取投资预览
 ...
 * @returns 投资预览信息
 */
function getInvestmentPreview(request) {
    const config = exports.INVESTMENT_CONFIGS[request.type];
    const faction = (0, storage_1.getFactionById)(request.factionId);
 ...
 * @returns 投资结果
 */
function executeInvestment(request, rollOverride) {
    const config = exports.INVESTMENT_CONFIGS[request.type];
    // 获取预览以验证
 ...
 * @returns 投资状态信息
 */
function getInvestmentStatus(factionId) {
 ...
 * @returns 有行动力的武士列表
 */
function getAvailableSamuraisForInvestment(factionId) {
    const samurais = (0, storage_1.getSamurais)();
