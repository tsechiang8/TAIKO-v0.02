...
router.get('/template/:type', (req, res) => {
    ...
    const template = (0, import_1.getImportTemplate)(type);
    res.json({
        success: true,
        data: {
            type,
...
router.post('/preview/:type', (req, res) => {
    ...
    switch (type) {
        case 'territory':
            parseResult = (0, import_1.parseTerritoryData)(text);
            break;
        case 'legion':
            parseResult = (0, import_1.parseLegionData)(text);
            break;
        case 'faction':
            parseResult = (0, import_1.parseFactionData)(text);
            break;
        case 'specialProduct':
            parseResult = (0, import_1.parseSpecialProductData)(text);
            break;
        default:
            res.status(400).json({
                success: false,
...
router.post('/:type', (req, res) => {
    ...
    const result = (0, import_1.importData)(type, text, overwrite);
